...
def add_issue_reaction(reaction: reaction_schema.IssueReactionIn):
    response = table.update_item(
        Key={
            "PK": "ISSUEREACTION#" +
            reaction.repo.repo_owner+"#" +
            reaction.repo.repo_name+"#" +
            str(reaction.issue_number) +
            "#"+reaction.user,
            "SK": "ISSUEREACTION#" +
            reaction.repo.repo_owner+"#" +
            reaction.repo.repo_name+"#" +
            str(reaction.issue_number)+"#"+reaction.user,
        },
...
def add_pullreq_reaction(reaction: reaction_schema.PullReqReactionIn):
    response = table.update_item(
        Key={
            ...
            reaction.repo.repo_owner+"#" +
            reaction.repo.repo_name+"#" +
            str(reaction.pullreq_number) +
            "#"+reaction.user,
            "SK": "PRREACTION#" +
            reaction.repo.repo_owner+"#" +
            reaction.repo.repo_name+"#" +
            str(reaction.pullreq_number)+"#"+reaction.user,
        },
        UpdateExpression="ADD Reactions :reaction",
        ConditionExpression="attribute_not_exists(Reactions)",
        ExpressionAttributeValues={
    ...
    response = table.update_item(
        Key={
            "PK": "PR#"+reaction.repo.repo_owner+"#"+reaction.repo.repo_name +
            "#"+zero_padded_pullreq,
            "SK": "PR#"+reaction.repo.repo_owner+"#"+reaction.repo.repo_name +
            "#"+zero_padded_pullreq
        },
        UpdateExpression="SET Reaction.#reaction = Reaction.#reaction + :count",
        ExpressionAttributeNames={
...
def add_issuecmt_reaction(reaction: reaction_schema.IssueCommentReactionIn):
    response = table.update_item(
        Key={
            ...
            "#"+reaction.repo.repo_name +
            "#"+str(reaction.issue_number) +
            "#"+reaction.user+"#"+reaction.comment_id,
            "SK": "ISSUEREACTION#" +
            reaction.repo.repo_owner +
            "#"+reaction.repo.repo_name +
            "#"+str(reaction.issue_number) +
...
def add_pullreqcmt_reaction(reaction: reaction_schema.PullReqCommentReactionIn):
    response = table.update_item(
        Key={
            "PK": "PRREACTION#"+reaction.repo.repo_owner+"#" +
            reaction.repo.repo_name+"#"+str(reaction.pullreq_number) +
            "#"+reaction.user+"#"+reaction.comment_id,
            "SK": "PRREACTION#"+reaction.repo.repo_owner+"#" +
            reaction.repo.repo_name+"#"+str(reaction.pullreq_number) +
            "#"+reaction.user+"#"+reaction.comment_id,
        },
        UpdateExpression="ADD Reactions :reaction",
    ...
    response = table.update_item(
        Key={
            "PK": "PRCOMMENT#"+reaction.repo.repo_owner+"#" +
            reaction.repo.repo_name +
            "#"+str(reaction.pullreq_number),
